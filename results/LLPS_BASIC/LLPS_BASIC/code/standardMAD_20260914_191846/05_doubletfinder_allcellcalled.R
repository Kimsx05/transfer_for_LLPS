...
start_time <- Sys.time()
log_message("05_doubletfinder_allCellCalled", "START", "input=QCflags_only_noFiltering", "cells=410466")
...
write_tsv_new(parameters, file.path(df_output_dir, "doubletfinder_allCellCalled_parameters.tsv"))
write_tsv_new(summaries, file.path(df_output_dir, "doubletfinder_allCellCalled_summary.tsv"))
...
write_lines_new(checkpoint, file.path(df_output_dir, "doubletfinder_allCellCalled_checkpoint_path.txt"))
log_message("05_doubletfinder_allCellCalled", "END", "all_cells=", ncol(qc_object),
